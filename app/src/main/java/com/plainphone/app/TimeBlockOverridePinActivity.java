...
public class TimeBlockOverridePinActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("Enter PIN to end this block early");
        root.addView(title);
        ...
        pinInput.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (s.length() >= 4 && Config.checkLockPin(TimeBlockOverridePinActivity.this, s.toString())) {
                    proceed();
                }
            }
        });
        ...
        unlock.setText("Continue");
        UiKit.style(this, unlock);
        unlock.setOnClickListener(v -> proceed());
    ...
    private void proceed() {
        ...
        submitted = true;
        Intent intent = new Intent(this, TimeBlockOverrideActivity.class);
